...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2024 at 04:17 PM
...
(29, 'sv_001', 'svpl_001', 90),
(30, 'sv_001', 'svpl_002', 73),
(32, 'sv_002', 'svpl_001', 98),
(33, 'sv_002', 'svpl_002', 77),
(37, 'sv_003', 'svpl_001', 40),
(38, 'sv_001', 'svpl_002', 73);
...
--
ALTER TABLE `perkuliahan`
  MODIFY `id_perkuliahan` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
ALTER TABLE `perkuliahan`
  ...
  ADD CONSTRAINT `FK_MATAKULIAH` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`);
COMMIT;
